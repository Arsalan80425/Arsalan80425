...
## 🚀 What I’ve Been Working On (Last Year)
...
## 🧪 Previous & Ongoing AI Projects
- 🖐️ **Virtual Mouse using Hand Gestures** (OpenCV + MediaPipe)
- ⚽ **Football Player Detection & Re-Identification** (YOLO + ReID)
- 🏥 **Disease Prediction System** (XGBoost, Random Forest, MLP – 97% precision)
- 📊 **Fraud Detection Dashboard** with explainability (SHAP)
- 🔐 **Quantum Communication Simulator** (BB84, QKD)
...
## ♟️ Fun Fact
I’ve been selected **twice** for the **Inter-IIIT Chess Team** 🏆
